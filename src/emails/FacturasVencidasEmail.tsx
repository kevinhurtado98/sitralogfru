...
const MONEDA_PRE: Record<string, string> = {
  SOLES: "S/",
  DOLARES: "$",
  EUROS: "€",
};
...
export function FacturasVencidasEmail({
  facturas,
    ...
    <Tailwind>
      <Html lang="es">
        ...
        <Body className="bg-[#f0ede8] m-0 py-8 font-sans">
          <Container className="max-w-145 mx-auto bg-white rounded-xl overflow-hidden border border-black/8">
            ...
            <Section className="px-8 pt-8 pb-6">
              ...
              <Text className="text-[#6b6b65] text-sm leading-relaxed m-0 mb-5">
                ...
                pendiente{total !== 1 ? "s" : ""} de registro contable o pagos
                por realizar.
              </Text>
                  ...
                  <Row className="mb-2">
                    ...
                    <Column className="text-right">
                      <Text className="text-[10px] font-bold text-amber-700 bg-amber-50 px-2 py-1 rounded m-0">
                        {f.diasVencida} día{f.diasVencida !== 1 ? "s" : ""}{" "}
                        vencida
                      </Text>
                    </Column>
                  </Row>
                  ...
                  <Row className="mb-2">
                    <Column>
                      ...
                      <Text className="text-[14px] font-bold text-[#1a1a18] m-0">
                        {MONEDA_PRE[f.moneda] ?? ""}{" "}
                        {f.montoNeto.toLocaleString("es-PE", {
