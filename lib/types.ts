...
export type FormaPago          = 'CREDITO' | 'FACTORING' | 'FACTURA_NEGOCIABLE' | 'LETRA'
export type Prioridad          = 'ALTA' | 'MEDIA'
export type TipoRequerimiento  = 'COMPRA' | 'SERVICIO'
export type EstadoRequerimiento = 'ATENDIDO_TOTAL' | 'ATENDIDO_PARCIAL' | 'PENDIENTE' | 'NO_ATENDIDO' | 'GESTION_REALIZADA'
export type Modulo             = 'COMPROBANTES' | 'REQUERIMIENTOS' | 'USUARIOS' | 'AUTH' | 'CONFIGURACION'
